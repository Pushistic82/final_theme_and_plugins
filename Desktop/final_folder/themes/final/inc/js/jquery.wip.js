...
//Yulia's code for the about us page
function showP() {
        if (document.getElementById('hiddenp').style.display == 'block') {
    ...
    function showPa() {
        if (document.getElementById('hiddenpa').style.display == 'block') {
            document.getElementById('hiddenpa').style.display = 'none';
        } else {
            document.getElementById('hiddenpa').style.display = 'block';
        }
    }

    function showPar() {
        if (document.getElementById('hiddenpar').style.display == 'block') {
            document.getElementById('hiddenpar').style.display = 'none';
        } else {
